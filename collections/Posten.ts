  ...
  fields: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'IT & Büroelektronik', value: 'IT' },
        { label: 'Sonstiges', value: 'sonstiges' },
		{ label: 'Gastronomie', value: 'Gastronomie' },
		{ label: 'Möbel & Einrichtung', value: 'Möbel' },
		{ label: 'Energie & Gebäudetechnik', value: 'energie' },
		{ label: 'Lager, Logistik & Reinigung', value: 'lager,reinigung' },
      ],
    },
    {
      name: 'preis',
